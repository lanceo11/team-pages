...
class GameLevelBasketball {
  constructor(gameEnv) {
    ...
    const image_src_court = path + '/_projects/characters/images/BaskCourt.png';
    ...
    const sprite_src_player = path + '/_projects/characters/images/astro.png';
    ...
    const sprite_src_chaser = path + '/_projects/characters/images/kirby.png';
